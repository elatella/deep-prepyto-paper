...
For our use-case, a common issue of these approaches with respect to our requirements is that the input data consists of 2-dimensional images.
In the first study, cryo-ET data are decomposed in individual 2-dimensional slices, which are input to the CNN separately. The independent output prediction images are re-assembled in a 3-dimensional stack.
