...
In the first study, cryo-ET data are decomposed in individual 2-dimensional slices, which are handed as separate input to the CNN. 
The independent output 2-dimensional prediction images are reassembled in a 3-dimensional stack.[@doi:10.1038/nmeth.4405]
...
To overcome this limitation, we used a U-Net CNN that takes 3-dimensional images as input [@arxiv:1606.06650].
